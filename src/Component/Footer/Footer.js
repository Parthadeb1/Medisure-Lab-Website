...
import {faEnvelopeOpenText, faPhoneSquareAlt, faStreetView } from '@fortawesome/free-solid-svg-icons';
...
const Footer = () => {
    ...
    return (
        <div className="container-fluid mt-4 bg-dark text-light">
            ...
            <div>
            <h1 className="fs-3 fw-bold">Medi<span className="text-danger">Health</span> </h1>
                <div className="w-50 text-auto">
                <p>Best Choice for Medical Health Care. We Serve the patient by our best Doctors who are best at their Depertment</p>
                </div>
            </div>
            </div>
